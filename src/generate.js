...
async function generateFiles(answers) {
    ...
    const tsTemplate = fs.readFileSync(path.resolve(__dirname, '../templates/normal/ts'), 'utf8');
    const tsGenerated = mustache.render(tsTemplate, context);
    const scssTemplate = fs.readFileSync(path.resolve(__dirname, '../templates/normal/scss'), 'utf8');
